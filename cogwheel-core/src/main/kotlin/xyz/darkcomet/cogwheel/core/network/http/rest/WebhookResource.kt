...
internal constructor(private val httpClient: CwHttpClient) {
    ...
    suspend fun createWebhook(
        ...
        val httpRequest = CwHttpRequest.create(POST, "/channels/${channelId}/webhooks") {
    ...
    suspend fun getChannelWebhooks(channelId: Snowflake): CwHttpResponse<List<WebhookObject>> {
        val httpRequest = CwHttpRequest.create(GET, "/channels/${channelId}/webhooks")
        val response = httpClient.submit(httpRequest)
    ...
    suspend fun getGuildWebhooks(guildId: Snowflake): CwHttpResponse<List<WebhookObject>> {
        val httpRequest = CwHttpRequest.create(GET, "/guilds/${guildId}/webhooks")
        val response = httpClient.submit(httpRequest)
    ...
    suspend fun getWebhook(webhookId: Snowflake): CwHttpResponse<WebhookObject> {
        val httpRequest = CwHttpRequest.create(GET, "/webhooks/${webhookId}")
        val response = httpClient.submit(httpRequest)
    ...
    suspend fun getWebhookWithToken(
        ...
        val httpRequest = CwHttpRequest.create(GET, "/webhooks/${webhookId}/${webhookToken}")
        val response = httpClient.submit(httpRequest)
    ...
    suspend fun deleteWebhook(
        ...
        val httpRequest = CwHttpRequest.create(DELETE, "/webhooks/${webhookId}")
        val response = httpClient.submit(httpRequest)
    ...
    suspend fun deleteWebhookWithToken(
        ...
        val httpRequest = CwHttpRequest.create(DELETE, "/webhooks/${webhookId}/${webhookToken}")
        val response = httpClient.submit(httpRequest)
