...
data class ApplicationCommand(
    ...
    val defaultMemberPermissions: Bitmask<Permission>?,
...
internal fun ApplicationCommandObject.toModel(): ApplicationCommand {
    return ApplicationCommand(
        ...
        defaultMemberPermissions = require(this, ApplicationCommandObject::defaultMemberPermissions)?.let { Bitmask.from(it) },
